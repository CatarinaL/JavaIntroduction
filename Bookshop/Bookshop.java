...
/**
 * Driver class for Bookshop System - sell books and manage inventory
 * 
...
public class Bookshop
{
    ...
    Book[] bookList;
    int itemsSold; // for an extra functionality that summarizes book sales before closing
    double netSales;
    ...
    public Bookshop()
    {
        ...
        System.out.println("\nYour Bookshop System is shutting down... ");
        System.out.println("\n\\\\\\\\");
        System.out.println("SUMMARY OF SALES ");
        System.out.println("Books sold: \t" + itemsSold);
        System.out.println("Net sales(excluding VAT): \t" + netSales + "€");
        System.out.println("\\\\\\\\");
        System.out.println("\nGoodbye!");
    }
    ...
    public Book selectBookMenu(Book[] books)
    {
        ...
        input.nextLine();
        while(option < 0 || option > books.length)
        {
            System.out.println("\n\t******Invalid option*****");
            System.out.println("\n\t-------BOOK SELECTION--------");
    ...
    {  
        ...
        if(selected.getStock() < amount)
        {
            ...
            itemsSold += amount;
            netSales += selected.getPrice() * amount;
        }
