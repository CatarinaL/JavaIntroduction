...
public class Bookshop
{
    ...
    {
      System.out.print("PUBLISHERS. How many publishers supply this Bookshop? (minimum 2)> ");
      int howManyPublishers = input.nextInt();
      input.nextLine();
            //TODO validate for min 2 here
      ...
      System.out.print("BOOKS. How many book titles are there in this Bookshop? (minimum 4)>");
      int howManyBooks = input.nextInt();
      input.nextLine();
            // validate for min 4 here
      ...
      for(int i=0; i < bookList.length; i++) //fill bookList array
      {
          ...
          System.out.println("Select a Publisher from the list... ");
            ...
            {
                System.out.println(publisher + "> " + publishers[publisher].getName());
            }
          int selectedPublisher = input.nextInt();
          input.nextLine();
          // validate publisher selection - or rewrite select to method?
